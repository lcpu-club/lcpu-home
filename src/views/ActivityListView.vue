...
<template>
  <div>
    ...
    <div flex="~ col gap-10" m-t-10>
      <div relative v-for="activityGroup in activityGroups" :key="activityGroup.year + '-' + activityGroup.month">
        ...
        <ActivityListEntry v-for="activity in activityGroup.items" :activity="activity" :key="activity.title" />
      </div>
    </div>
  </div>
</template>
